...
int main() {
  ...
  assert(solve({2, 46, 54, 78, 137, 149, 175, 209, 297, 324, 348, 392, 398, 415, 440, 576, 600, 628, 646, 655, 819, 837, 931, 944, 964, 979, 1048, 1067, 1092, 1096, 1101, 1135, 1259, 1302, 1305, 1352, 1360}, 7) == 206);
  assert(solve({49, 67, 82, 92, 109, 121, 124, 127, 149, 150, 164, 194, 204, 207, 239, 244, 264}, 5) == 43);
